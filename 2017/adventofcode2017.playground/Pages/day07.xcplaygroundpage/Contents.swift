...
func parseNodeString(_ nodeStr: Substring) -> RawTree {
    ...
    return RawTree(name: name, weight: weight, childrenNames: childNames)
}

func parseUnstructured(_ input: String) -> [String: RawTree] {
...
func part1_rootNodeName(_ nodes: [String: RawTree]) -> String {
...
func part2_targetWeightForUnbalancedNode(_ nodes: [String: RawTree]) -> Int {
